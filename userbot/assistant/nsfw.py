...
@devub.tgbot.on(CallbackQuery(data=re.compile(r"^age_verification_true")))
...
@devub.tgbot.on(CallbackQuery(data=re.compile(r"^age_verification_false")))
...
@devub.tgbot.on(CallbackQuery(data=re.compile(r"^chg_of_decision_")))
