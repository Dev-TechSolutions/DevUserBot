        ...
        **kwargs,
        ...
        def decorator(func):  # sourcery no-metrics
            async def wrapper(check):  # sourcery no-metrics
                ...
                try:
                    ...
                    if not disable_errors:
                        ...
                        text = "**DevUserbot Error report**\n\n"
                        link = "[here](https://t.me/)"
            ...
            if pattern is not None:
                ...
                if edited:
                    devub.add_event_handler(func, events.MessageEdited(**kwargs))
                devub.add_event_handler(func, events.NewMessage(**kwargs))
            return wrapper
    ...
    def bot_cmd(
        ...
        **kwargs,
        ...
        def decorator(func):
            ...
            if edited is True:
                devub.tgbot.add_event_handler(func, events.MessageEdited(**kwargs))
            else:
                devub.tgbot.add_event_handler(func, events.NewMessage(**kwargs))
