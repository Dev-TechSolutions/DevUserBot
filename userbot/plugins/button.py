...
# button post makker for Devuserbot thanks to uniborg for the base

# by @sandy1709 (@Samarth-Dubey)
import os
import re
...
from . import devub, edit_delete, reply_id
...
@devub.dev_cmd(
    ...
    info={
        ...
        "examples": "{tr}cbutton test [google]<buttonurl:https://www.google.com> [Devuserbot]<buttonurl:https://t.me/Devuserbot17:same> [support]<buttonurl:https://t.me/Devuserbot_support>",
    },
)
async def _(event):
...
@devub.dev_cmd(
    ...
    info={
        ...
        "examples": "{tr}ibutton test [google]<buttonurl:https://www.google.com> [Devuserbot]<buttonurl:https://t.me/Devuserbot17:same> [support]<buttonurl:https://t.me/Devuserbot_support>",
    },
)
async def _(event):
    ...
    if not markdown_note:
        return await edit_delete(event, "`what text should i use in button post`")
    devinput = "Inline buttons " + markdown_note
    results = await event.client.inline_query(Config.TG_BOT_USERNAME, devinput)
