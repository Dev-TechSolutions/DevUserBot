...
from . import deEmojify, devub, edit_or_reply
...
async def carbon_api(event):
    ...
    dev = await edit_or_reply(event, "`Carbonizing...\n25%`")
    ...
    await dev.edit("`Processing..\n75%`")

    await asyncio.sleep(2)
    await dev.edit("`Done Dana Done...\n100%`")
    file = "./carbon.png"
    await dev.edit("`Uploading..`")
...
async def carbon_api(event):
    """A Wrapper for carbon.now.sh"""
    dev = await edit_or_reply(event, "`Processing....`")
    CARBON = "https://carbon.now.sh/?l={lang}&code={code}"
    textx = await event.get_reply_message()
    pcode = event.text
    if pcode[5:]:
...
async def carbon_api(event):
    ...
    await dev.edit("🔳🔳🔳🔳🔳")
    file = "./carbon.png"
    await dev.edit("☣️Karbon1 Completed, Uploading Karbon☣️")
    await event.client.send_file(
        event.chat_id,
        file,
        force_document=True,
...
async def carbon_api(event):
    ...
    await dev.edit("🔘🔘🔘🔘🔘")
    file = "./carbon.png"
    await dev.edit("☣️Karbon2 Completed, Uploading Karbon☣️")
    await event.client.send_file(
        event.chat_id,
        file,
...
async def carbon_api(event):
    ...
    await dev.edit("🔵🔵🔵🔵🔵")
    file = "./carbon.png"
    await dev.edit("☣️Karbon3 Completed, Uploading Karbon⬆️")
    await event.client.send_file(
        event.chat_id,
        file,
...
async def carbon_api(event):
    ...
    await dev.edit("🌝🌝🌝🌝🌝")
    file = "./carbon.png"
    await dev.edit("✅Karbon4 Completed, Uploading Karbon✅")
    await event.client.send_file(
        event.chat_id,
        file,
...
async def carbon_api(event):
    ...
    await dev.edit("⬛⬛⬛⬛⬛")
    file = "./carbon.png"
    await dev.edit("✅RGB Karbon Completed, Uploading Karbon✅")
    await event.client.send_file(
        event.chat_id,
        file,
