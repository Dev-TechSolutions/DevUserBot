...
from . import devub, edit_or_reply
...
@devub.dev_cmd(
    ...
    info={
        ...
        "examples": "{tr}getc 10 @Devuserbot17",
    },
)
async def get_media(event):
    devty = event.pattern_match.group(1)
    limit = int(devty.split(" ")[0])
    channel_username = str(devty.split(" ")[1])
