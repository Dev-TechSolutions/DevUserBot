...
from . import CMD_HELP, CMD_LIST, SUDO_LIST, devub, edit_delete, edit_or_reply, reply_id
...
@devub.dev_cmd(
    ...
    info={
        ...
        "description": "Reply to any external plugin(supported by dev) to install it in your bot.",
        "usage": "{tr}install",
    },
)
