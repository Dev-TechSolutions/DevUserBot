...
@devub.dev_cmd(
    ...
    info={
        ...
        "examples": "{tr}fmusical Devuserbot",
    },
)
...
@devub.dev_cmd(
    ...
    info={
        ...
        "examples": "{tr}ancient Devuserbot",
    },
)
async def stylish_generator(event):
    "Changes font style of the given text"
...
@devub.dev_cmd(
    ...
    info={
        ...
        "examples": "{tr}smallcaps Devuserbot",
    },
)
async def stylish_generator(event):
    "Changes font style of the given text"
...
@devub.dev_cmd(
    ...
    info={
        ...
        "examples": "{tr}blackbf Devuserbot",
    },
)
async def stylish_generator(event):
    "Changes font style of the given text"
...
@devub.dev_cmd(
    ...
    info={
        ...
        "examples": "{tr}bubbles Devuserbot",
    },
)
async def stylish_generator(event):
    "Changes font style of the given text"
...
@devub.dev_cmd(
    ...
    info={
        ...
        "examples": "{tr}smothtext Devuserbot",
    },
)
async def stylish_generator(event):
    "Changes font style of the given text"
...
@devub.dev_cmd(
    ...
    info={
        ...
        "examples": "{tr}doublef Devuserbot",
    },
)
async def stylish_generator(event):
    "Changes font style of the given text"
