...
async def source(e):
    ...
    await edit_or_reply(
        e,
        "Click [here](https://github.com/Tgdevub/Devuserbot) to open this bot source code\
...
@devub.dev_cmd(
    ...
    command=("github", plugin_devegory),
    info={
        ...
        "examples": [".github samarth1709", ".github -l5 samarth1709"],
    },
)
async def _(event):
    ...
    async with aiohttp.ClientSession() as session:
        async with session.get(URL) as request:
            ...
            devevent = await edit_or_reply(event, "`fetching github info ...`")
...
@devub.dev_cmd(
    pattern="commit$",
    command=("commit", plugin_devegory),
    info={
