...
@devub.dev_cmd(
    ...
    info={
        ...
        "examples": [
            ...
            "{tr}gs -l6 Devuserbot",
            "{tr}gs -p2 Devuserbot",
            "{tr}gs -p2 -l7 Devuserbot",
        ],
    },
)
async def gsearch(q_event):
    "Google search command."
    devevent = await edit_or_reply(q_event, "`searching........`")
...
@devub.dev_cmd(
    ...
    command=("reverse", plugin_devegory),
    info={
        "header": "Google reverse search command.",
...
async def _(img):
    ...
    if message and message.media:
        ...
        return
    if photo:
        devevent = await edit_or_reply(img, "`Processing...`")
        try:
            image = Image.open(photo)
        except OSError:
            return await devevent.edit("`Unsupported , most likely.`")
        name = "okgoogle.png"
        image.save(name, "PNG")
        image.close()
        ...
        if response != 400:
            ...
            return await devevent.edit("`Unable to perform reverse search.`")
        ...
        if guess and imgspage:
            await devevent.edit(f"[{guess}]({fetchUrl})\n\n`Looking for this Image...`")
        else:
            return await devevent.edit("`Can't find any kind similar images.`")
...
@devub.dev_cmd(
    ...
    command=("google", plugin_devegory),
    info={
