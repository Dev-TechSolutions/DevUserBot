...
async def gps(event):
    ...
    devevent = await edit_or_reply(event, "`finding.....`")
    geolocator = Nominatim(user_agent="Devuserbot")
    ...
    if geoloc:
        ...
        await devevent.edit("`i coudn't find it`")
