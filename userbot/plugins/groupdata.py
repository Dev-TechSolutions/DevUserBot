...
@devub.dev_cmd(
    ...
    command=("admins", plugin_devegory),
    info={
        ...
        "examples": "{tr}admins @Devuserbot_support",
    },
)
async def _(event):
...
@devub.dev_cmd(
    ...
    info={
        ...
        "examples": "{tr}bots @Devuserbot_support",
    },
)
async def _(event):
    "To get list of bots."
...
async def get_users(show):
    ...
    devevent = await edit_or_reply(show, "`getting users list wait...`  ")
    try:
...
@devub.dev_cmd(
    ...
    command=("chatinfo", plugin_devegory),
    info={
        ...
        "examples": "{tr}chatinfo @Devuserbot_support",
    },
)
async def info(event):
    "To get group information"
    devevent = await edit_or_reply(event, "`Analysing the chat...`")
    ...
    try:
        ...
        await devevent.edit("`An unexpected error has occurred.`")
...
async def get_chatinfo(event, devevent):
    ...
    try:
        ...
        try:
            ...
            await devevent.edit("`Invalid channel/group`")
            return None
            ...
            await devevent.edit("`Channel or supergroup doesn't exist`")
            return None
        except (TypeError, ValueError) as err:
            LOGS.info(err)
            await edit_delete(devevent, "**Error:**\n__Can't fetch the chat__")
            return None
    return chat_info
