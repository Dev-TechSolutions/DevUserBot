...
@devub.dev_cmd(
    pattern="unlock ([\s\S]*)",
    command=("unlock", plugin_devegory),
    info={
...
@devub.dev_cmd(
    pattern="punlock ([\s\S]*)",
    command=("punlock", plugin_devegory),
    info={
...
@devub.dev_cmd(incoming=True, forword=None)
