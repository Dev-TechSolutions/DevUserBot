# pm and tagged messages logger for Devuserbot by @Samarth-Dubey (@samarth1709)
import asyncio
...
@devub.dev_cmd(incoming=True, func=lambda e: e.mentioned, edited=False, forword=None)
...
@devub.dev_cmd(
    ...
    command=("grplog", plugin_devegory),
    info={
