...
async def Oof(e):
    "Animation command."
    t = "Oof"
    devevent = await edit_or_reply(e, t)
    for _ in range(15):
        await asyncio.sleep(0.5)
        t = t[:-1] + "of"
        await devevent.edit(t)


@devub.dev_cmd(
    pattern="type ([\s\S]*)",
    command=("type", plugin_devegory),
    info={
...
@devub.dev_cmd(
    pattern="sadmin$",
    command=("sadmin", plugin_devegory),
    info={
