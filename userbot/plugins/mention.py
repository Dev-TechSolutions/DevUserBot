...
@devub.dev_cmd(
    ...
    command=("tagall", plugin_devegory),
    info={
...
@devub.dev_cmd(
    pattern="report$",
    command=("report", plugin_devegory),
    info={
...
@devub.dev_cmd(
    pattern="men ([\s\S]*)",
    command=("mention", plugin_devegory),
    info={
        ...
        "examples": ["{tr}men @Samarth-Dubey hi", "Hi @Samarth-Dubey[How are you?]"],
    },
)
async def _(event):
