...
async def ocr(event):
    ...
    devevent = await edit_or_reply(event, "`Reading...`")
    ...
    try:
        ...
        await devevent.edit("`Couldn't read it.`\n`I guess I need new glasses.`")
    else:
        await devevent.edit(f"**Here's what I could read from it:**\n\n`{ParsedText}`")
