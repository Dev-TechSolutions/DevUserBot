...
@devub.dev_cmd(
    pattern="purgefrom$",
    command=("purgefrom", plugin_devegory),
    info={
...
@devub.dev_cmd(
    pattern="purgeto$",
    command=("purgeto", plugin_devegory),
    info={
...
@devub.dev_cmd(
    pattern="purgeme",
    command=("purgeme", plugin_devegory),
    info={
...
@devub.dev_cmd(
    ...
    command=("upurge", plugin_devegory),
    info={
