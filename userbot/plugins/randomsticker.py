...
@devub.dev_cmd(
    pattern="dev$",
    command=("dev", plugin_devegory),
    info={
        "header": "To get random dev stickers.",
        "usage": "{tr}dev",
    },
)
async def _(event):
    "To get random dev stickers."
    await event.delete()
