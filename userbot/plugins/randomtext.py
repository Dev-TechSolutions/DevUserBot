...
async def _(event):  # sourcery no-metrics
    ...
    if x == 16:
        await event.edit(
            '`"200 years ago, people would never have guessed that humans in the future would communideve by silently tapping on glass."`'
        )
    if x == 17:
        await event.edit(
