...
@devub.dev_cmd(
    ...
    command=("recognize", plugin_devegory),
    info={
...
async def _(event):
    ...
    dev = await edit_or_reply(event, "recognizeing this media")
    async with event.client.conversation(chat) as conv:
        try:
            ...
            await dev.edit("unblock @Rekognition_Bot and try again")
            return
        if response.text.startswith("See next message."):
            ...
            await dev.edit("sorry, I couldnt find it")
